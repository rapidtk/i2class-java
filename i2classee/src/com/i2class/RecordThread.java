...
/**
 * A record class used to pass values from a stalled (e.g. READ/EXFMT) thread.
 * @author Andrew Clark
 * @see RdspfThread
 */
public class RecordThread extends RecordWorkstn
{
	//RdspfThread file;
	...
	public RecordThread(String recordName)
	{
		super(recordName);
	}
