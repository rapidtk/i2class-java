...
public class RecordThreadSFL extends RecordThread implements IRecordSFL//, IRecordSFLX
{
	RecordSFL sfl_ = new RecordSFL();
	public int recno;
	int pageSize;
	//RrecordThreadSFLCTL sflctl;
	 ...
	 */
	public RecordThreadSFL(String recordName)
	{
		super(recordName);
	}
	...
	*/ 
	 ...
	 */
	String getSflContent(String contentType)
	{
