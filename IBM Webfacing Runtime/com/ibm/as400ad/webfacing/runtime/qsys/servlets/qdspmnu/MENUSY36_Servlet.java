...
public class MENUSY36_Servlet extends HttpServlet
{

    public MENUSY36_Servlet()
    {
    }
        ...
        throws IOException, ServletException
    {
        ...
        try
        {
            ...
            {
                idisplayrecord = (IDisplayRecord)httpsession.getAttribute("MENUSY36");
                if(idisplayrecord == null)
                    throw new InstantiationException("bean MENUSY36  not found within scope ");
            }
            if(!flag);
            printwriter.write("\r\n");
            ...
            printwriter.print(s);
            printwriter.write("_MENUSY36_version\" NAME=\"l");
            printwriter.print(s);
            printwriter.write("_MENUSY36_version\" VALUE=501020000>\r\n<TR id=\"l");
            printwriter.print(s);
            printwriter.write("r21\" class=\"trStyle\">\r\n");
            byte byte0 = 1;
            printwriter.write("\r\n<TD NOWRAP colspan=4 rowspan=1><span id='l");
            printwriter.print(s);
            printwriter.write("_MENUSY36$Unnamed2'  class=\"wf_green wf_field\"  onClick=\"setCursor(21, 2);\" >===&gt;</span></TD>");
            byte0 = 5;
            ...
            printwriter.print(s);
            printwriter.write("_MENUSY36$CMDLINE\" previousValue=\"");
            ...
            printwriter.print(s);
            printwriter.write("_MENUSY36$Unnamed3'  class=\"wf_blue wf_field\"  onClick=\"setCursor(22, 2);\" ></span></TD>");
            byte0 = 79;
            printwriter.write("\r\n</TR>\r\n<TR id=\"l");
            printwriter.print(s);
            ...
            if(idisplayrecord.isFieldVisible("Unnamed1"))
            {
                ...
                printwriter.print(s);
                printwriter.write("_MENUSY36$Unnamed1'  class=\"wf_blue wf_field\"  onClick=\"setCursor(23, 2);\" ></span></TD>");
                byte0 = 80;
                printwriter.write("\r\n");
            }
            printwriter.write("\r\n");
            if(idisplayrecord.isFieldVisible("Unnamed0"))
            {
                ...
                printwriter.write("\r\n<TD NOWRAP colspan=79 rowspan=1><span id='l");
                printwriter.print(s);
                printwriter.write("_MENUSY36$Unnamed0'  class=\"wf_default wf_field\"  onClick=\"setCursor(23, 2);\" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></TD>");
                byte0 = 80;
                printwriter.write("\r\n");
            }
            printwriter.write("\r\n");
            ...
            printwriter.write("\r\n<TD NOWRAP colspan=78 rowspan=1><span id='l");
            printwriter.print(s);
            printwriter.write("_MENUSY36$MSGLINE'  class=\"wf_hi wf_white wf_field\"  >");
