...
public class MENUSYJavaScript_Servlet extends HttpServlet
{

    public MENUSYJavaScript_Servlet()
    {
    }
        ...
        throws IOException, ServletException
    {
        ...
        try
        {
            ...
            printwriter.write("\r\ncf(\"l");
            printwriter.print(i);
            printwriter.write("_MENUSY$CMDLINE\",21,7,{");
            ...
            printwriter.write("check:\"LC;\",datalength:73,shift:\"Y\"});\r\nrc(\"l");
            printwriter.print(i);
            printwriter.write("_MENUSY$MSGLINE\",24,2);\r\n");
        }
