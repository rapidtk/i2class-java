...
public class MENULN36_Servlet extends HttpServlet
{

    public MENULN36_Servlet()
    {
    }
        ...
        throws IOException, ServletException
    {
        ...
        try
        {
            ...
            {
                idisplayrecord = (IDisplayRecord)httpsession.getAttribute("MENULN36");
                if(idisplayrecord == null)
                    throw new InstantiationException("bean MENULN36  not found within scope ");
            }
            if(!flag);
            printwriter.write("\r\n");
            ...
            printwriter.print(s);
            printwriter.write("_MENULN36_version\" NAME=\"l");
            printwriter.print(s);
            printwriter.write("_MENULN36_version\" VALUE=501020000>\r\n<TR id=\"l");
            printwriter.print(s);
            printwriter.write("r22\" class=\"trStyle\">\r\n");
            byte byte0 = 0;
            printwriter.write("\r\n<TD colspan=1>&nbsp;</TD>\r\n<TD NOWRAP colspan=4 rowspan=1><span id='l");
            printwriter.print(s);
            printwriter.write("_MENULN36$Unnamed0'  class=\"wf_green wf_field\"  onClick=\"setCursor(22, 2);\" >===&gt;</span></TD>");
            byte0 = 5;
            ...
            printwriter.print(s);
            printwriter.write("_MENULN36$CMDLINE\" previousValue=\"");
            ...
            printwriter.print(s);
            printwriter.write("_MENULN36$MSGLINE'  class=\"wf_hi wf_white wf_field\"  >");
