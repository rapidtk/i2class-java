...
public class SCRN1CTL_Servlet extends HttpServlet
{
        ...
        throws IOException, ServletException
    {
        ...
        try
        {
            ...
            {
                idisplaysflctlrecord = (IDisplaySFLCTLRecord)httpsession.getAttribute("SCRN1CTL");
                if(idisplaysflctlrecord == null)
                    throw new InstantiationException("bean SCRN1CTL  not found within scope ");
            }
            if(!flag);
            printwriter.write("\r\n");
            ...
            printwriter.print(s);
            printwriter.write("_SCRN1CTL_version\" NAME=\"l");
            printwriter.print(s);
            printwriter.write("_SCRN1CTL_version\" VALUE=501020000>\r\n<TR>\r\n");
            IScrollbarBean iscrollbarbean = null;
            boolean flag2 = false;
            synchronized(httpservletrequest)
            {
                iscrollbarbean = (IScrollbarBean)httpsession.getAttribute("SCRN1CTL$Scrollbar");
                if(iscrollbarbean == null)
                    throw new InstantiationException("bean SCRN1CTL$Scrollbar  not found within scope ");
            }
            if(!flag2);
            printwriter.write("\r\n");
            ...
            printwriter.write("\r\n</TD>\r\n<TD id='l");
            printwriter.print(s);
            printwriter.write("_SCRN1CTL$scrollbarCell' colspan=1 rowspan=16 cellspacing='0' cellpadding='0'>\r\n<!-- begin of scrollbar --->\r\n");
            ...
            for(int l = 1; l <= 15; l++)
            {
                ...
                if(idisplaysflctlrecord.isActiveRecord(i1))
                {
                    ...
                    printwriter.print(s);
                    printwriter.write("_SCRN1CTL$MSGDATA$");
            ...
            printwriter.write("\r\n<TR><TD id='l");
            printwriter.print(s);
            printwriter.write("_SCRN1CTL$cellBelowScrollbar'></TD></TR>\r\n");
