...
public class MENUSN36_Servlet extends HttpServlet
{

    public MENUSN36_Servlet()
    {
    }
        ...
        throws IOException, ServletException
    {
        ...
        try
        {
            ...
            {
                idisplayrecord = (IDisplayRecord)httpsession.getAttribute("MENUSN36");
                if(idisplayrecord == null)
                    throw new InstantiationException("bean MENUSN36  not found within scope ");
            }
            if(!flag);
            printwriter.write("\r\n");
            ...
            printwriter.print(s);
            printwriter.write("_MENUSN36_version\" NAME=\"l");
            printwriter.print(s);
            printwriter.write("_MENUSN36_version\" VALUE=501020000>\r\n<TR id=\"l");
            printwriter.print(s);
            printwriter.write("r23\" class=\"trStyle\">\r\n");
            byte byte0 = 1;
            printwriter.write("\r\n<TD NOWRAP colspan=4 rowspan=1><span id='l");
            printwriter.print(s);
            printwriter.write("_MENUSN36$Unnamed0'  class=\"wf_green wf_field\"  onClick=\"setCursor(23, 2);\" >===&gt;</span></TD>");
            byte0 = 5;
            ...
            printwriter.print(s);
            printwriter.write("_MENUSN36$CMDLINE\" previousValue=\"");
            ...
            printwriter.print(s);
            printwriter.write("_MENUSN36$MSGLINE'  class=\"wf_hi wf_white wf_field\"  >");
