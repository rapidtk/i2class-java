...
class HJISysNameRequest extends HJIRequest
{

    public HJISysNameRequest()
    {
        super(18);
    }
    ...
    void logError(IOException ioexception)
    {
        ...
        itracelogger.err(2, "Communications error while receiving reply to the request to retrieve the system name " + ioexception.getMessage());
