...
class HJICurSymRequest extends HJIRequest
{

    public HJICurSymRequest()
    {
        super(0);
    }
    ...
    void logError(IOException ioexception)
    {
        ...
        itracelogger.err(2, "Communications error while receiving reply to the request to retrieve the currency symbol: " + ioexception.getMessage());
