...
class HJIDatSepRequest extends HJIRequest
{

    public HJIDatSepRequest()
    {
        super(9);
    }
    ...
    void logError(IOException ioexception)
    {
        ...
        itracelogger.err(2, "Communications error while receiving reply to the request to retrieve the job's QDATSEP value: " + ioexception.getMessage());
