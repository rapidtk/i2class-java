...
public class HJIPFieldMappingStringRequest extends HJIRequest
{

    public HJIPFieldMappingStringRequest()
    {
        super(20);
    }
    ...
    void logError(IOException ioexception)
    {
        ...
        itracelogger.err(2, "Communications error while receiving reply to the request to retrieve the PFIELD conversion map " + ioexception.getMessage());
