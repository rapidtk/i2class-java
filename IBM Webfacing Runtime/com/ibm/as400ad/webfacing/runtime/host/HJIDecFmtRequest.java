...
class HJIDecFmtRequest extends HJIRequest
{

    public HJIDecFmtRequest()
    {
        super(13);
    }

    public char getDecimalFormat()
    {
    ...
    void logError(IOException ioexception)
    {
        ...
        itracelogger.err(2, "Communications error while receiving reply to the request to retrieve the job's QDECFMT: " + ioexception.getMessage());
