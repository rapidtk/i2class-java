...
/**
 * A mutable date class similar to the OS/400 date data type.
 * 
 ...
 * @author Andrew Clark
 */
public class date extends fixed
{
	...
	public date(String datfmt400, date value)
	{
		this(datfmt400);
		updating=true;
		try
	...
	{
		return new date(datfmt400, value);
	}
	 ...
	 * Just to differentiate between the public datfmt400 constructor.
	 */
	date(String datfmt, int length, String datfmt400)
	{
	 ...
	 * Assign another date value to this date class.
	 */
	public void assign(date value) throws ParseException
	{
	...
	fixed CharJava(String datfmt)
	{
		...
		try
		{
			...
			//return s;
			fixed fStr = new fixed(s.length(), s);
			return fStr;
		}
		catch (Exception e)
		{
	 ...
	 */
	public fixed Char(String datfmt400)
	{
	...
	{
		return date.getDateFormat(datfmt400);
	}
	 ...
	 * @return date
	 */
	public date minusdur(int duration, int durationCode) throws Exception
	{
	 ...
	 * @return date 
	 */
	public date minusdur(INumeric duration, int durationCode) throws Exception
	{
	 ...
	 * Subtract a duration from this date and return a new date object.
	 */
	public date minus(Duration duration) throws Exception
	{
	 ...
	 * @return date 
	 */
	public date plusdur(int duration, int durationCode) throws Exception
	{
		String s = plusdurString(duration, durationCode);
		date d1 = (date) clone();
		d1.assign(s);
	 ...
	 * @return date
	 */
	public date plusdur(INumeric duration, int durationCode) throws Exception
	{
	 ...
	 * Add a duration and return a new date object.
	 */
	public date plus(Duration duration) throws Exception
	{
	...
	private date date0() throws ParseException
	{
		/*
	...
	public void move(date value) throws ParseException
	{
		assign(value);
	}
	...
	static String datfmt0(date value)
	{
	...
	public int compareTo(date value) throws ParseException
	{
