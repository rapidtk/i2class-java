 ...
 * @author ANDREWC
 */
public class fixedExternal extends fixed {
	...
	protected fixedExternal(IRecordFormat rcdFmt, pointer overlay)
	{
	...
	static FixedData getFixedData_(int fieldIndex, IRecordFormat recordFormat, fixed value, Vector fixedDataTypes)
	{
