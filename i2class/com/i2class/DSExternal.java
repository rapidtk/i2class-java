 ...
 * @author Andrew Clark 
 */
public class DSExternal extends fixedExternal
{
	 ...
	 */
	public DSExternal(IRecordFormat rcdFmt, int elem)
	{
	...
	public Object clone()
	{
		DSExternal cloned = (DSExternal)super.clone();
