 ...
 * @author Andrew Clark 
 */
public class zoned extends AbstractNumeric {
	...
	*/
	...
	public zoned(int length, int scale, pointer overlay)
	{
	...
	*/
	...
	public BigDecimal toBigDecimal() {
		...
		return bd;
		*/
		return numeric.newBigDecimal(toNumericString());
	}
