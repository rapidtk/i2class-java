 ...
 *
 */
public /*final*/ class numeric extends DecimalData implements IFixed {
	...
	public Object clone() 
	{
		numeric	cloned = new numeric(length, Scale);
