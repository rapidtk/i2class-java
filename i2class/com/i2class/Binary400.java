...
/**
 * A mutable class that represents os/400 binary data stored (with its weird length rules) in fixed-length data.
 *  
 */
public class Binary400 extends FixedBinary {
	 ...
	 */
	public Binary400(int length, int scale) {
		super(length <= 4 ? 2 : 4);
		m_scale = scale;
	}
