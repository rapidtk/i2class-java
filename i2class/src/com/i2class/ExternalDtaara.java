 ...
 *
 */
public class ExternalDtaara extends CharDtaara {
	...
	public ExternalDtaara(IRecordFormat rcdFmt, AS400 system, String dtaaraName)
	{
		super(rcdFmt.size(), system, dtaaraName);
		recordFormat = rcdFmt;
	}
	public ExternalDtaara(IRecordFormat rcdFmt, I2AS400 system, String dtaaraName)
	{
		super(rcdFmt.size(), system, dtaaraName);
		recordFormat = rcdFmt;
	}
	/** Create a local data area object. */
	public ExternalDtaara(IRecordFormat rcdFmt, Connection host, String dtaaraName)
	{
		super(rcdFmt.size(), host, dtaaraName);
		recordFormat = rcdFmt;
	}
	/** Create a remote (JDBC) data area object. */
	public ExternalDtaara(IRecordFormat rcdFmt, I2Connection rconn, String dtaaraName)
	{
