 ...
 */
public class CharDtaara extends FixedChar
{

	protected ICharacterDtaara dtaara;
	public CharDtaara(int sz, AS400 system, String dtaaraName)
	{
		super(sz);
		dtaara = getDtaara(system, dtaaraName);
	}
	/** Create a remote AS400 data area object. */
	public CharDtaara(int sz, I2AS400 system, String dtaaraName)
	{
		this(sz, system.getAS400(), dtaaraName);
	}
	public CharDtaara(int sz, Connection host, String dtaaraName)
	{
		super(sz);
		dtaara = getDtaara(dtaaraName);
	}
	/** Create a remote (JDBC) data area object. */
	public CharDtaara(int sz, I2Connection rconn, String dtaaraName)
	{
		super(sz);
	 ...
	 * @param value The value to set
	 */
	public static void chgdtaara(AS400 host, String dtaara, FixedChar value)
		throws Exception
	{
		String s = value.toFixedString();
	 ...
	 * @param value The value to set
	 */
	public static void chgdtaara(Connection host, String dtaara, FixedChar value)
		throws Exception
	{
		String s = value.toFixedString();
		chgdtaara(host, dtaara, s);
