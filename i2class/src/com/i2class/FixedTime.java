 ...
 *
 */
public class FixedTime extends FixedDate {
	public FixedTime()
	{
		this("*ISO");
	}
	
	public FixedTime(String timfmt400)
	{
		super(getTimeFormat(timfmt400), 0, timfmt400);
	}
	
	public FixedTime(String timfmt400, Hival value)
	{
		this(timfmt400);
		assign(value);
	}
	
	public FixedTime(String timfmt400, Loval value)
	{
		this(timfmt400);
		assign(value);
	}
	 ...
	 */
	FixedTime(String datfmt, int length, String datfmt400) {
		super(datfmt, length, datfmt400);
	}


	/** Create a time with an initial time value */
	public FixedTime(String timfmt400, FixedTime value)
	{
		this(timfmt400);
		updating=true;
		try
	 ...
	 */
	public FixedTime(FixedPointer overlay)
	{
	 ...
	 */
	public FixedTime(String datfmt400, String inzval)
	{
		this(datfmt400);
		updating=true;
		assign(inzval);
	...
	{
		return new FixedTime(datfmt400, (FixedTime)value);
	}
